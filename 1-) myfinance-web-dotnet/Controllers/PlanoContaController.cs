...
namespace myfinance_web_dotnet.Controllers
{
  ...
  public class PlanoContaController : Controller
  {
    ...
    {
      var listaPlanoContas = _planoContaService.ListItems();
    ...
    public IActionResult Cadastrar(int? Id)
    {
      if (Id != null)
      {
        var planoConta = _planoContaService.GetItem((int)Id);
        var palnoContaModel = new PlanoContaModel()
        {
          Id = planoConta.Id,
          Descricao = planoConta.Descricao,
          Tipo = planoConta.Tipo
        };
        Console.WriteLine($"Descricao: {planoConta.Descricao}");
      }
      return View();
    }
    ...
    public IActionResult Cadastrar(PlanoContaModel model)
    {
      ...
      _planoContaService.Register(planoConta);
