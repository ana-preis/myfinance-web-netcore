...
using Microsoft.AspNetCore.Mvc.Rendering; // Adicionado para importar SelectList
...
namespace myfinance_web_dotnet.Controllers
{
  ...
  public class TransacaoController : Controller
  {
    ...
    public TransacaoController(
      ...
      IPlanoContaService planoContaService) // Adicionado para injetar IPlanoContaService
    {
      _logger = logger;
      _transacaoService = transacaoService;
      _planoContaService = planoContaService; // Inicializado o serviço
    }
    [HttpGet]
    [Route("Index")]
    public IActionResult Index()
    {
      var listaTransacaos = _transacaoService.ListItems();
    ...
    public IActionResult Cadastrar(int? Id){
      var ListaPlanoContas = new SelectList(_planoContaService.ListItems(), "Id", "Descricao");
      var itemTransacao = new TransacaoModel(){
        Data = DateTime.Now,
      ...
      if (Id != null){
        var transacao = _transacaoService.GetItem((int)Id);
    ...
    public IActionResult Cadastrar(TransacaoModel model)
    {
      ...
      _transacaoService.Register(transacao);
